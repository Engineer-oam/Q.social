...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Check if profile exists, if not, they need to onboard
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-q-text-muted">Enter your credentials to continue</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-q-panel text-q-text-muted">Or continue with</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-q-text-muted">
          ...
          <Link to="/register" className="text-q-primary hover:text-q-primary-hover font-medium transition-colors">
            Create one
          </Link>
        </p>
      </motion.div>
